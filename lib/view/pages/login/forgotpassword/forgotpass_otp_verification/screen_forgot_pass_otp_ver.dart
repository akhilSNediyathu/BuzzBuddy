    ...
    return BlocConsumer<ResetPasswordBloc, ResetPasswordState>(
      listener: (context, state) {
        if(state is ResetPasswordSuccesState){
          customSnackbar(context, 'succes', green);
                        ...
                        BlocBuilder<ResetPasswordBloc, ResetPasswordState>(
                          builder: (context, state) {
                            if(state is ResetPasswordLoadingState){
                              loadingButton(media: media, onPressed: (){}, color: kDefaultIconLightColor);
                            }
                            return customButton(
                                                  media: media,
                                                  buttonText: 'Save',
                                                  onPressed: () {
                                                    if (_formKey.currentState!.validate()) {
                                                     ...
                                                     context.read<ResetPasswordBloc>().add(OnResetPasswordButtonClickedEvent(email: email,password: _confirmPasswordController.text));
                                    ...
                                    BlocBuilder<ResetPasswordBloc, ResetPasswordState>(
                                      builder: (context, state) {
                                        if(state is OtpverifiedLoadingState ){
                                          loadingButton(media: media, onPressed: (){}, color: kPrimaryColor);
                                        }
                                        return customMaterialButton(
                                                                                     onPressed: () async {
                                                                                                  ...
                                                                                                  if (validateOtp()) {
                                                                                                    ...
                                                                                                    context.read<ResetPasswordBloc>().add(OnVerifyButtonClickedEvent(email:email,otp: otp));
