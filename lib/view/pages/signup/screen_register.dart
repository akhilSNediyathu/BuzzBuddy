                                    ...
                                    return customButton(
                                                                    ...
                                                                    onPressed: () async {
                                                                      ...
                                                                      if (_formKey.currentState!.validate()) {
                                                                        ...
                                                                        context.read<SignUpBloc>().add(OnSignupButtonClickedEvent(userName: _usernameController.text, password: _passwordController.text,phoneNumber: _phoneController.text, email: _emailController.text));
                                                                      } else {
